...
// Get all batches and departments for filters
$batches = $db->query("SELECT DISTINCT batch_name FROM batches ORDER BY batch_name");
                            ...
                            <select class="form-select" id="batch" name="batch">
                                ...
                                <?php while ($batch = $batches->fetch_assoc()): ?>
                                    <option value="<?php echo htmlspecialchars($batch['batch_name']); ?>"
                                            <?php echo $filterBatch === $batch['batch_name'] ? 'selected' : ''; ?>>
